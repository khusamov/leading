...
- [Создание пользовательской темы](#3-3)
	- [Подготовка рабочего пространства](#)
	- [Создание темы (пакета типа тема)](#3)
	- [Наследование темы](#)
		- [Modern Toolkit](#modern-toolkit)
		- [Classic Toolkit](#classic-toolkit)
		- [Какую тему следует расширить для вашей пользовательской темы?](#3)
	- [Сборка темы](#)
- [Создание тестового приложения](#3)
	- [Изменение темы приложения](#3)
	- [Запуск приложения в режиме watch](#3----watch)
- [АПИ тем](#)
	- [Настройка глобальных переменных темы](#)
	- [Патчи темы (Overrides)](#overrides)
	- [Изменение изображений базовой темы](#3-3-3)
	- [Добавление пользовательских функций и примесей](#3)
- [Стилизация вашего приложения](#3)
	- [Стилизация представлений вашего приложения](#3)
	- [Изменение переменных темы в вашем приложении](#3)
- [Изменение дизайна компонент](#3-3)
	- [Изменение переменных темы для компонент](#3)
	- [Использование примесей для компонент](#3)
	- [Изменение изображений компонент](#3-3)
- [Префиксы](#)
- [Дополнительные замечания](#3)
	- [Изображения компонента из ui === default](#3--3-ui-default)
- [Ссылки](#)
...
sass/src/ | Правила и миксины (с использованием переменных, определенных в sass/var). Эта папка содержит исходные файлы SASS, имитирующие иерархию классов компонентов. Эти файлы собираются в сборке CSS на основе классов, которые используются в сборке.
