...
Вы можете организовать файлы в этом каталоге, как вам нравится, но единственный файл, который Sencha Cmd включает в сборку my-theme/sass/etc/all.scss. Любые другие файлы должны быть импортированы (при помощи @import) в файл all.scss. Для примера, который следует этому правилу, см. ext/classic/theme-base/sass/etc/.
